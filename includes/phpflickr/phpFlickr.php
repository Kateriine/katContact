	...
	class phpFlickr {
		...
		function buildPhotoURL ($photo, $size = "Medium") {
			...
			if ($size == "original") {
				...
				$infos = $this->photos_getInfo($photo['id']);
				$url = "https://farm" . $photo['farm'] . ".static.flickr.com/" . $photo['server'] . "/" . $photo['id'] . "_" . $infos['photo']['originalsecret']  . "_o" . "." . $infos['photo']['originalformat'] ;
			} else {
