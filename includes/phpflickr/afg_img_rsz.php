...
if(! defined('FILE_CACHE_DIRECTORY') )      define ('FILE_CACHE_DIRECTORY', '/home/newwipspadebe/webpublishing/wp-content/flickr');             // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
